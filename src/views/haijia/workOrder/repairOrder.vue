        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <!--派工-->
              <el-button v-show="dispatchedBut" @click="onDispatchedData(scope.row)" type="text" size="small"
                         v-model="dialogTitle">{{title.dispatchedTxt}}
              </el-button>
              <!--报工-->
              ...
              <!--查看-->
              <el-button v-show="showBut" @click="onShowData(scope.row)" type="text" size="small" v-model="dialogTitle">
                {{title.showTxt}}
              </el-button>
              <!--取消-->
...
<script>
    ...
    import dispatchedDlog from './components/repairDispatched-dlog';
    import seeDlog from './components/repairShow-dlog';
    import reportWorkDlog from './components/repairReport-dlog';
    import examineDlog from './components/repairExamine-dlog';
