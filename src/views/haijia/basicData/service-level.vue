<template>
  <div>
    <el-row>
      ...
      <el-col :span="12" align="right">
        <el-form :inline="true" :model="formInline" @submit.native.prevent>
          <el-form-item>
            <el-input v-model="formInline.name" placeholder="请输入名称" clearable @keyup.enter.native="onQuery"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <service-level-log :show-dlog="showDlog" :dialog-title="dialogTitle"
                       @onServiceLevelLog="getData"></service-level-log>
  </div>
</template>

<script>
    import serviceLevelLog from './components/service-level-dialog'
